...
export default function OpportunityDetailPage() {
  return (
    <>
      <Sidebar />
      <TopAppBar />
      <main className="ml-64 mt-16 h-[calc(100vh-4rem)] overflow-y-auto bg-background">
        {/* Hero */}
        ...
        {/* Bento Content Grid */}
        <div className="px-margin-desktop py-stack-lg grid grid-cols-12 gap-gutter max-w-container-max mx-auto">
          {/* Left Column */}
